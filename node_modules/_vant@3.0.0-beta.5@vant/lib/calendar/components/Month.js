...
var _default = createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var monthStyle = (0, _vue.computed)(function () {
      if (!shouldRender.value) {
        var rowCount = Math.ceil((totalDay.value + offset.value) / 7);
        var padding = rowCount * (0, _utils.unitToPx)(props.realRowHeight);
        return {
    ...
    (0, _vue.watch)(function () {
      ...
      (0, _vue.nextTick)(function () {
        height.value = (0, _use.useRect)(monthRef).height;
      });
    });
    (0, _vue.watch)(shouldRender, function (value) {
      if (value) {
        (0, _vue.nextTick)(function () {
