...
function useEventListener(type, listener, options) {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onMounted)(add);
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onActivated)(add);
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      return (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)(popup, (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.mergeProps)({
        ...
        default: function _default() {
          return [renderHeader(), renderDescription(), renderOptions(), slots.default && (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.createVNode)("div", {
            "class": action_sheet_bem('content')
          }, [slots.default()]), renderCancel()];
        }
      });
    };
  }
...
/* harmony default export */ var Month = (Month_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var monthStyle = (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.computed)(function () {
      if (!shouldRender.value) {
        var rowCount = Math.ceil((totalDay.value + offset.value) / 7);
        var padding = rowCount * unitToPx(props.realRowHeight);
        return {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.watch)(function () {
      return props.realRowHeight;
    }, function () {
      (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.nextTick)(function () {
        height.value = useRect(monthRef).height;
      });
    });
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.watch)(shouldRender, function (value) {
      if (value) {
        (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.nextTick)(function () {
          if (dayRefs.value[0] && !props.realRowHeight) {
            var _dayRefs$value$0$$el$ = dayRefs.value[0].$el.getBoundingClientRect(),
                _height = _dayRefs$value$0$$el$.height;

            emit('update-height', _height);
          }
        });
      }
    });
...
/* harmony default export */ var calendar = (utils_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onActivated)(init);
    useExpose({
      reset: reset
    });
    return function () {
...
function useVisibilityChange(target, onChange) {
  ...
  (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onMounted)(observe);
  (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onActivated)(observe);
...
/* harmony default export */ var swipe = (swipe_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onActivated)(initialize);
...
/* harmony default export */ var datetime_picker = (datetime_picker_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      var Component = props.type === 'time' ? TimePicker : DatePicker;
  ...
  setup: function setup(props, _ref) {
    ...
    var renderIndex = function renderIndex() {
      if (props.showIndex) {
        ...
        }, [slots.index ? slots.index() : state.active + 1 + " / " + props.images.length]);
      }
    };
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.watch)(function () {
      ...
      if (value) {
        ...
        (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.nextTick)(function () {
          resize();
          swipeRef.value.swipeTo(+startPosition, {
            immediate: true
          });
        });
      } else {
...
/* harmony default export */ var index_bar = (index_bar_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var getAnchorTop = function getAnchorTop(element, scrollParentRect) {
      if (scrollParent.value === window || scrollParent.value === document.body) {
        return getElementTop(element);
      }

      var rect = useRect(element);
...
/* harmony default export */ var notice_bar = (notice_bar_createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onActivated)(start); // fix cache issues with forwards and back history in safari
...
/* harmony default export */ var progress = (progress_createComponent({
  ...
  setup: function setup(props) {
    ...
    (0,external_root_Vue_commonjs_vue_commonjs2_vue_amd_vue_.onMounted)(setWidth);
    return function () {
