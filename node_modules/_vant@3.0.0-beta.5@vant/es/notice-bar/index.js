import { ref, watch, reactive, nextTick, onActivated, createVNode, vShow, withDirectives } from "vue";
import { isDef, createNamespace } from '../utils'; // Composition

import { useRect, doubleRaf, useEventListener } from '@vant/use'; // Components
...
export default createComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    onActivated(start); // fix cache issues with forwards and back history in safari
